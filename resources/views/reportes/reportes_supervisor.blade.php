...
<head>
    ...
    <title>Reporte de la obra {{ $obra }} del cliente {{ $cliente }}</title>
    ...
    <div class="container shadow-lg p-3 mb-5 mt-5 bg-body rounded">
        ...
        <div class="row">
            <div class="offset-2 col-6">
                <h5 class="text-center">Reporte de la obra {{ $obra }} del cliente {{ $cliente }}</h5>
            ...
            <div class="col">
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody class=" align-middle">
                        @foreach ($reporte_supervisor as $item)
                            @if ($item->herramienta != '')
                                <tr style="background-color: #ffffff;">
                            @endif
                            @if ($item->herramienta == '')
                                <tr style="background-color: #f9f505;">
                            @endif
               ...
               {{ $item->empleado }}</td>
                            ...
                            @php $empleado = $item->empleado; @endphp
                        @endforeach
                    </tbody>
                </table>
            </div>
