...
<div class="container shadow-lg p-3 mb-5 mt-5 bg-body rounded">
  ...
  <button type="button" class="btn btn-1" data-bs-toggle="modal" data-bs-target="#nuevaherramienta">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
  ...
  <div class="modal fade" id="nuevaherramienta" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="row">
            <div class="col-6">
                <form action="{{ route('add_herramienta_excel') }}" method="POST" enctype="multipart/form-data"/>
                @csrf
                <div class="file-input text-center  ">
                    ...
                    <label class="file-input__label" for="file-input">
                      ...
                      <span class="" >
                        <img src="https://cdn.icon-icons.com/icons2/195/PNG/256/Excel_2013_23480.png" width="30" height="20" alt="">
                ...
                <form action="{{ route('addherramienta') }}" method="POST">
                    ...
                    <div class="mb-3" class="autocomplete">
                      ...
                      <div class="autocomplete" style="widht:500px;">
                        <input required id="myInput" type="text" name="nombre" class="form-control" >
                      </div>
                    </div>
